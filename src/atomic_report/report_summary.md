...
- Tests excluded (execution failed, no alert produced): **26** (see `tables/failed_tests.csv`)
- Tests that failed to run but still produced an alert - **counted, not excluded**: **12** (see `tables/failed_but_counted.csv`)
- Tests considered for detection stats: **221**
- Techniques tested: **50**
- Detected: **104** (47.1%)
- Undetected (including techniques with no rule): **117**
- Distinct rules triggered: **54**

## 2. Technique classification

- Fully detected: **19** technique(s)
- No rule: **11** technique(s)
- Partially detected: **10** technique(s)
- Not detected: **8** technique(s)
...
| T1546.003   |                3 |             3 |              0 |                100   | Fully detected     | Yes        |
...
- T1098 test 13: + FullyQualifiedErrorId : CouldNotAutoloadMatchingModule
...
- T1546 test 8: + CategoryInfo          : NotSpecified: (:) [Copy-Item], DirectoryNotFoundException
